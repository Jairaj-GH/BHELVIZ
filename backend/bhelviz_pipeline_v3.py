...
from bhelviz_model_impl import BhelvizNLPModel, build_model

# ---------------------------------------------------------------------------
# Dynamic department list loaded at application startup (from Oracle)
# ---------------------------------------------------------------------------
try:
    from metadata import KNOWN_DEPARTMENTS
except ImportError:
    # Fallback if metadata module is not available – replace with actual loader
