...
/* â”€â”€ MOCK DATABASE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
const EMPLOYEES = Array.from({ length: 200 }, (_, i) => ({
  ...
  no_enc: `AES-GCM::${btoa("E" + i).replace(/=/g, "").slice(0, 12)}â€¦`,
  name: `${["A.K.","B.","C.","D.R.","E.","F.","G.","H.","I.","J.K."][i % 10]} ${["Sharma","Kumar","Patel","Singh","Nair","Reddy","Rao","Mehta","Joshi","Iyer"][i % 10]}`,
  name_enc: `AES-GCM::${btoa("Name" + i).replace(/=/g, "").slice(0, 20)}â€¦`,
  dept: DEPTS[i % 7],
...
const INIT_PENDING = [
  { id: 1, name: "Arjun Mehta", email: "a.mehta@bhel.in", dept: "Power Systems", reason: "Q2 attendance audit â€” division head requested analysis access", ts: "2026-05-12 09:14" },
...
/* â”€â”€ NLP â†’ IR via Anthropic API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
async function fetchIR(query, history) {
  ...
  const resp = await fetch("https://api.anthropic.com/v1/messages", {
    ...
    headers: {
      ...
      "x-api-key": apiKey,                  // â† add this line
      "anthropic-version": "2023-06-01",    // â† add this line
      "anthropic-dangerous-direct-browser-access": "true",  // â† required for browser calls
    },
    body: JSON.stringify({
...
/* â”€â”€ MOCK QUERY ENGINE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function runQuery(ir, isDecrypted) {
  ...
  const display = rows.map(r => ({
    ...
    "Status": r.status,
    "Hired": r.hired,
    "Penalty": r.penalty !== null ? r.penalty : "â€”",
  }));
...
/* â”€â”€ MICRO COMPONENTS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
const Spinner = () => (
    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: C.bg0 }}>
      <Panel style={{ maxWidth: 440, width: "90%", padding: 40, textAlign: "center", animation: "fadein 0.4s ease" }}>
        ...
        <div style={{ color: C.text, fontSize: 12, lineHeight: 1.9, marginBottom: 20 }}>
          ...
          <span style={{ color: C.textBright }}>â‘  Encrypted Decoding Manual (email)</span><br />
          <span style={{ color: C.textBright }}>â‘¡ Manual password (separate SMS)</span><br />
          <span style={{ color: C.textBright }}>â‘¢ DB credentials (time-limited secure link)</span>
        </div>
        ...
        <div style={{ marginTop: 20, display: "flex", justifyContent: "center" }}>
          <Btn onClick={() => setSubmitted(false)} variant="ghost">â† Back to login</Btn>
        </div>
      </Panel>
    </div>
  );
    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: C.bg0, backgroundImage: `radial-gradient(ellipse at 25% 50%, rgba(21,88,200,0.07) 0%,transparent 55%), radial-gradient(ellipse at 75% 50%, rgba(196,138,8,0.05) 0%,transparent 55%)` }}>
      ...
      <div style={{ width: "100%", maxWidth: 400, padding: 20, animation: "fadein 0.5s ease", position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 9, color: C.textDim, letterSpacing: 4, marginTop: 6 }}>SECURE Â· READ-ONLY Â· VOICE-ENABLED Â· ZERO-TRUST</div>
            ...
            {tab === "login" ? (
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                <div>
                  ...
                  <Inp value={pwd} onChange={setPwd} type="password" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" onKeyDown={e => e.key === "Enter" && doLogin()} />
                </div>
                ...
                <div style={{ textAlign: "center", fontFamily: "'JetBrains Mono',monospace", fontSize: 9, color: C.textDim }}>
                  ...
                  User demo: any @bhel.in email + â‰¥4 char password
                </div>
              </div>
            ) : (
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <textarea className="input-card" value={form.reason} onChange={e => setForm(f => ({ ...f, reason: e.target.value }))} placeholder="Business justification for accessâ€¦"
        ...
        <div style={{ textAlign: "center", marginTop: 14, fontFamily: "'JetBrains Mono',monospace", fontSize: 8, color: C.textDim, letterSpacing: 1 }}>
          ALL ACCESS LOGGED Â· TLS 1.3 Â· ORACLE 19c Â· ZERO-TRUST ARCHITECTURE
        </div>
      </div>
    </div>
  );
...
/* â”€â”€ ADMIN CONSOLE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function AdminScreen({ onLogout, notify }) {
  ...
  const approve = u => {
    ...
    notify(`âœ“ ${u.name} approved â€” credentials and Decoding Manual issued.`, "success");
  };
  const deny = u => {
    setPending(p => p.filter(x => x.id !== u.id));
    setSel(null);
  ...
  const SYS = [
    { l: "Oracle 19c Enterprise", ok: true, d: "Session: CONNECTED Â· TDE: ACTIVE" },
    { l: "App-Level AES-256-GCM", ok: true, d: "Client-side only Â· Server never decrypts" },
    { l: "NLP Engine (FLAN-T5)", ok: true, d: "IR output only Â· No DB route Â· Isolated" },
    { l: "Query Executor", ok: true, d: "READ-ONLY Â· No internet Â· Hardened container" },
    { l: "Oracle Key Vault (HSM)", ok: true, d: "nShield Solo XC Â· Auto-rotation: 90d" },
    { l: "Admin Console", ok: true, d: "mTLS Â· MFA: ENFORCED Â· Isolated VPC" },
    { l: "Audit SIEM (Splunk)", ok: true, d: "Immutable log Â· 0 critical alerts" },
    { l: "Oracle Data Redaction", ok: true, d: "7 column policies active" },
    { l: "Database Vault", ok: true, d: "Realm protection: ACTIVE Â· DBA bypass: BLOCKED" },
    ...
    <div style={{ background: C.bg0, height: "100vh", color: C.text, fontFamily: "'Inter',sans-serif", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      <div style={{ background: C.bg1, borderBottom: `1px solid ${C.border}`, padding: "10px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <Badge bg={'var(--surface-dark)'} fg={C.goldBright}>â— ADMINISTRATOR</Badge>
        </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: sel ? "1fr 380px" : "1fr", gap: 16, animation: "fadein 0.2s ease" }}>
                ...
                {pending.length === 0
                  ...
                  : pending.map(u => (
                    <Panel key={u.id} style={{ padding: 16, marginBottom: 10, cursor: "pointer", borderColor: sel?.id === u.id ? C.goldBright : C.border, animation: "fadein 0.2s ease", transition: "border-color 0.2s" }} onClick={() => setSel(s => s?.id === u.id ? null : u)}>
                      ...
                      <div style={{ fontSize: 10, color: C.text, marginBottom: 8 }}>{u.dept} Â· {u.ts}</div>
                      <div style={{ fontSize: 11, color: C.textDim, fontStyle: "italic", borderTop: `1px solid ${C.border}`, paddingTop: 8 }}>"{u.reason}"</div>
                      <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
                        <Btn onClick={e => { e.stopPropagation(); approve(u); }} variant="ok" style={{ fontSize: 10, padding: "5px 12px" }}>âœ“ APPROVE</Btn>
                        <Btn onClick={e => { e.stopPropagation(); deny(u); }} variant="err" style={{ fontSize: 10, padding: "5px 12px" }}>âœ— DENY</Btn>
                      </div>
                    </Panel>
                  ))
                }
              ...
              {sel && (
                <Panel style={{ padding: 18, animation: "fadein 0.2s ease", alignSelf: "start" }}>
                  ...
                  {[["Name", sel.name], ["Email", sel.email], ["Department", sel.dept], ["Requested", sel.ts], ["DB Role", `bviz_ro_${sel.email.split("@")[0]}`], ["Access Level", "SELECT on ciphertext views only"], ["Manual Format", "AES-256-GCM Â· Argon2id KDF"], ["Manual Delivery", "S/MIME encrypted email (one-time link)"], ["Password Delivery", "OTP via separate SMS channel"], ["Audit Trail", "Immutable Â· SIEM-forwarded"]].map(([k, v]) => (
                  ...
                  <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
                    <Btn onClick={() => approve(sel)} variant="ok">âœ“ APPROVE & ISSUE</Btn>
                    <Btn onClick={() => deny(sel)} variant="err">âœ— DENY</Btn>
                  </div>
                </Panel>
              )}
            </div>
...
export default function OldDashboard({ userRole, onLogout, notify, token }) {
  ...
  const unlockManual = () => {
    if (manualPwd.length < 6) { notify("Manual password must be â‰¥6 characters", "error"); return; }
    setUnlockingManual(true);
    setTimeout(() => {
      setUnlockingManual(false); setDecrypted(true); setShowManualBar(false);
      notify("ðŸ”“ Decoding Manual unlocked. AES-256-GCM keys loaded into WebCrypto API. Volatile memory only.", "success");
    }, 2000);
  };
  ...
  const toggleVoice = () => {
    ...
    r.onerror = () => { setListening(false); notify("Voice error â€” use text input.", "error"); };
    r.start(); recogRef.current = r; setListening(true);
    notify("ðŸŽ¤ Listeningâ€¦ speak your BHELVIZ query.", "info");
  };
    ...
    try {
      if (token) {
        ...
        const display = rows.map(r => ({
          ...
          'Penalty': (r.penalty !== undefined && r.penalty !== null) ? r.penalty : (r.attendance_penalty !== undefined ? r.attendance_penalty : 'â€”'),
        }));
      ...
      notify(`âœ“ ${rawCount} records retrieved â€” client-side decryption complete`, "success");
  ...
  const SAMPLES = [
    ...
    "Anomaly detection â€” penalty cases this week",
  ];
    ...
    <div style={{ background: C.bg0, height: "100vh", color: C.text, fontFamily: "'Inter',sans-serif", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ background: C.bg1, borderBottom: `1px solid ${C.border}`, padding: "9px 18px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          {decrypted ? <Badge bg={'var(--surface-dark)'} fg={C.okBright}>ðŸ”“ DECRYPTED</Badge> : <Badge bg={'var(--surface-dark)'} fg={C.errBright}>ðŸ”’ ENCRYPTED</Badge>}
        </div>
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          <Dot ok={true} />
          <span style={{ fontSize: 9, color: C.textDim, fontFamily: "'JetBrains Mono',monospace" }}>READ-ONLY Â· ORACLE 19c</span>
      ...
      {showManualBar && (
        <div style={{ background: C.bg3, borderBottom: `1px solid rgba(232,168,32,0.4)`, padding: "10px 18px", display: "flex", alignItems: "center", gap: 14, animation: "fadein 0.3s ease", flexShrink: 0 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 9, color: C.textDim }}>Enter your manual password to unlock client-side AES-256-GCM decryption. This password never leaves your device â€” server has zero knowledge.</div>
          </div>
          <Inp value={manualPwd} onChange={setManualPwd} type="password" placeholder="Manual passwordâ€¦" style={{ width: 190, flexShrink: 0 }} onKeyDown={e => e.key === "Enter" && unlockManual()} />
          ...
          {unlockingManual && <span style={{ fontSize: 9, color: C.goldBright, fontFamily: "'JetBrains Mono',monospace", animation: "pulse 0.5s infinite", flexShrink: 0 }}>Deriving key via Argon2idâ€¦</span>}
        </div>
      )}
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
            ...
            <div style={{ padding: 12 }}>
              ...
              {qHistory.map((h, i) => (
                <div key={i} onClick={() => setQ(h.q)} style={{ padding: "3px 6px", cursor: "pointer", marginBottom: 4 }}>
                  ...
                  <div style={{ fontSize: 8, color: C.textDim, fontFamily: "'JetBrains Mono',monospace" }}>{h.ts} Â· {h.n} rows</div>
                </div>
              ))}
            </div>
          )}
            ...
            <div style={{ display: "flex", gap: 10, alignItems: "stretch" }}>
              <div style={{ flex: 1, position: "relative" }}>
                <textarea className="search-large" value={q} onChange={e => setQ(e.target.value)} disabled={!decrypted}
                  placeholder={decrypted ? "Type or speak: 'Show absent executives in Power Systems today'â€¦" : "Unlock Decoding Manual above to enable querying"}
                ...
                {listening && <div style={{ position: "absolute", right: 8, top: 8, fontFamily: "'JetBrains Mono',monospace", fontSize: 8, color: C.errBright, animation: "pulse 0.6s infinite" }}>â— REC</div>}
              </div>
          ...
          <div style={{ flex: 1, overflow: "auto", padding: "14px 16px" }}>
            ...
            {decryptAnim && (
              <Panel style={{ padding: 14, marginBottom: 12, display: "flex", gap: 12, alignItems: "center", borderColor: C.goldBright, animation: "pulse 0.5s infinite" }}>
                ...
                <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: C.goldBright }}>
                  Compiling IR â†’ Oracle parameterized SELECT â†’ Retrieving ciphertext â†’ Decrypting AES-256-GCM payload in WebCryptoâ€¦
                </span>
              </Panel>
            )}
              ...
              <div style={{ animation: "fadein 0.3s ease" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 }}>
                  <div>
                    ...
                    <span style={{ marginLeft: 10, fontFamily: "'JetBrains Mono',monospace", fontSize: 9, color: C.textDim }}>{results.rawCount} rows Â· {results.intent}</span>
                  </div>
                  <div style={{ display: "flex", gap: 4, alignItems: "center" }}>
                    ...
                    <div style={{ marginLeft: 8, display: "flex", gap: 4 }}>
                      <button onClick={() => { setFeedback("up"); notify("Feedback recorded â€” reward model updated", "success"); }} style={{ background: feedback === "up" ? C.ok : C.bg3, border: "none", borderRadius: 2, padding: "4px 8px", fontSize: 12 }}>ðŸ‘</button>
                      <button onClick={() => { setFeedback("down"); notify("Negative feedback recorded â€” RLHF queue updated", "info"); }} style={{ background: feedback === "down" ? C.err : C.bg3, border: "none", borderRadius: 2, padding: "4px 8px", fontSize: 12 }}>ðŸ‘Ž</button>
                    </div>
                  </div>
                </div>
            ...
            {!results && !loading && !decryptAnim && (
              <div style={{ textAlign: "center", padding: 60, color: C.textDim, animation: "fadein 0.4s ease" }}>
                <div style={{ fontSize: 48, marginBottom: 16, opacity: 0.2 }}>â—ˆ</div>
        ...
        {ir && (
          <div style={{ width: 245, background: C.bg1, borderLeft: `1px solid ${C.border}`, overflow: "auto", flexShrink: 0, padding: 12 }}>
            ...
            <div style={{ fontSize: 9, color: C.textDim, marginBottom: 10, lineHeight: 1.6 }}>NLP â†’ IR only. No SQL emitted. Server compiles IR â†’ parameterized SELECT with bind params.</div>
            ...
            <Panel style={{ marginTop: 10, padding: 10 }}>
              ...
              {["read_only: âœ“", "no_sql_emission: âœ“", "bind_params_only: âœ“", "row_limit_enforced: âœ“", "no_ddl_dml: âœ“", "ai_never_sees_rows: âœ“", "client_decryption_only: âœ“"].map(inv => (
            ...
            <Panel style={{ marginTop: 10, padding: 10 }}>
              ...
              <div style={{ fontSize: 8, color: C.text, fontFamily: "'JetBrains Mono',monospace", lineHeight: 1.6 }}>
                R = 0.35Â·valid_ir<br />+ 0.25Â·exec_success<br />+ 0.20Â·semantic_match<br />- 0.30Â·policy_violation<br />- 1.00Â·unsafe_output
              </div>
            </Panel>
          </div>
        )}
      ...
      <div style={{ background: C.bg1, borderTop: `1px solid ${C.border}`, padding: "4px 18px", display: "flex", gap: 16, alignItems: "center", flexShrink: 0, fontFamily: "'JetBrains Mono',monospace", fontSize: 8, color: C.textDim }}>
        ...
        <span style={{ marginLeft: "auto" }}>BHELVIZ v2.0.0-DEFENSE Â· {new Date().toLocaleString("en-IN")}</span>
      </div>
    </div>
  );
}
